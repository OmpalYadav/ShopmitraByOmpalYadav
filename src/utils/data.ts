...
export const footerLinks = [
  {
    ...
    list: ["About Shopmitra", "Connect with Us", "Shopmitra Cares", "Gift a Smile"],
  },
  {
    title: "Make Money with Us",
    list: [
      "Sell products on Shopmitra",
      "Sell apps on Shopmitra",
      "Become an Affiliate",
      "Advertise Your Products",
      "Self-Publish with Us",
      "Host a Shopmitra Hub",
      "› See More",
    ],
  },
  {
    title: "Shopmitra Payment",
    list: [
      "Shopmitra Business Card",
      "Shop with Points",
      "Reload Your Balance",
      "Shopmitra Currency Converter",
    ],
  },
  {
    title: "Let Us Help You",
    list: [
      "Shopmitra and COVID-19",
